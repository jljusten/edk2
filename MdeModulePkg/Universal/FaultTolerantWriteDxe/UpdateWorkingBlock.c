  ...
  )
{
  ...
  //
  if (CompareGuid (&gWorkingBlockSignatureGuid, &mWorkingBlockHeader.Signature)) {
    //
  ...
  //
  // Here using gWorkingBlockSignatureGuid as the signature.
  //
  CopyMem (
    &mWorkingBlockHeader.Signature,
    &gWorkingBlockSignatureGuid,
    sizeof (EFI_GUID)
    );
