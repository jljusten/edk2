/** @file
 Define the GUID gFaultTolerantWriteGuid that will be used to build
...
#define FAULT_TOLERANT_WRITE_GUID \
  { \
    0x1d3e9cb8, 0x43af, 0x490b, { 0x83,  0xa, 0x35, 0x16, 0xaa, 0x53, 0x20, 0x47 } \
  }

//
// FTW Last write data. It will be used as gFaultTolerantWriteGuid GUID hob data.
//
typedef struct {
  ///
...
//
extern EFI_GUID gFaultTolerantWriteGuid;
