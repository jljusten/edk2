...
lgdtOffsetInstruction:
;        mov ax, [cs:lgdtOffsetInstruction]
        BITS 64
        db  0xbb
        dq  gdtr - 0xffff0000 + 0x9090909090900000
        BITS 16
...
;        jmp $
;    jmp     LINEAR_CODE_SEL:jumpTo32BitAndLandHere
BITS    32
...
gdtr:
    ...
    dd      GDT_BASE
    dq      jumpTo32BitAndLandHere + (LINEAR_CODE_SEL << 32)
